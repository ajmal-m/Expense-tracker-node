...
const { getMonthlyExpense , getMonthlyCategoryWiseExpense , getCurrentMonthExpense, budgetVersesExpense } = require('../controllers/analytics-controller');
...
router.get('/budget-analytics', authenticatedRoute, budgetVersesExpense);
